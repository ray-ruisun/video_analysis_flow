...
# Emotion labels - keep icons for visual expression
EMOTION_LABELS = {
...
# Prosody labels - no icons needed
PROSODY_LABELS = {
...
# Camera & Visual Labels - no icons needed for technical terms
CAMERA_ANGLE_LABELS = {
    "eye-level": "Eye Level",
    "eye level": "Eye Level",
    "overhead": "Overhead (top-down)",
    "45° overhead": "45° Overhead",
    "low angle": "Low Angle",
...
# Color labels - keep color circle icons for visual reference
COLOR_HUE_LABELS = {
    "red": "🔴 Red",
    "orange": "🟠 Orange",
    "yellow": "🟡 Yellow",
...
# Saturation labels - no icons needed
SATURATION_LABELS = {
    "low": "Low (muted)",
    "moderate": "Moderate",
    "high": "High (vivid)",
...
# Brightness labels - no icons needed
BRIGHTNESS_LABELS = {
    "dark": "Dark",
    "dim": "Dim",
    "medium": "Medium",
...
# Contrast labels - no icons needed
CONTRAST_LABELS = {
    "low": "Low (flat)",
    "medium": "Medium",
    "high": "High (dramatic)",
...
# Lighting labels - no icons needed
LIGHTING_LABELS = {
...
# Audio Labels - keep music icons for relevant items
BGM_STYLE_LABELS = {
    "pop": "Pop",
    "rock": "Rock",
...
# Mood labels - keep emotion icons
MOOD_LABELS = {
    "happy": "😊 Happy",
    "sad": "😢 Sad",
    "energetic": "Energetic",
...
# Instrument labels - keep music icons
INSTRUMENT_LABELS = {
    "piano": "🎹 Piano",
    "guitar": "🎸 Guitar",
    "drums": "🥁 Drums",
...
# Scene Categories - keep location icons for key places
SCENE_LABELS = {
    "kitchen": "🍳 Kitchen",
...
# YOLO Object Labels - keep icons only for easily recognizable objects
OBJECT_LABELS = {
    "person": "👤 Person",
    "bicycle": "Bicycle",
    "car": "🚗 Car",
...
# Material Labels - no icons needed for technical terms
MATERIAL_LABELS = {
    "wood": "Wood",
    "metal": "Metal",
    "plastic": "Plastic",
...
# Environment Types - minimal icons
ENVIRONMENT_LABELS = {
...
# AI Detection Verdicts - keep status icons
AI_VERDICT_LABELS = {
    "real": "✅ Real (Authentic)",
    "likely real": "✅ Likely Real",
    "deepfake": "⚠️ Deepfake Detected",
    "synthetic": "⚠️ AI-Generated Synthetic",
    "suspicious": "⚠️ Suspicious",
    "ai-generated": "⚠️ AI-Generated",
    "unknown": "Unknown",
}
